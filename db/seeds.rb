...
andrasub = Subscription.create!(title: "Andra's Subscription", price: 10.00, status: 0, frequency: 1, customer_id: andra.id)
...
jamessub = Subscription.create!(title: "James's Subscription", price: 100.00, status: 0, frequency: 2, customer_id: james.id)
...
raynessub = Subscription.create!(title: "Jon's Subscription", price: 10.00, status: 0, frequency: 1, customer_id: raynes.id)
...
chrissub = Subscription.create!(title: "Chris's Subscription", price: 15.00, status: 1, frequency: 0, customer_id: chris.id)
